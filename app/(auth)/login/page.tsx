  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm glass-panel rounded-toolkit p-8">
        ...
        <p className="text-muted text-sm mb-6 font-lora">Sign in to your campaign archives</p>
        ...
        <div className="mt-6 pt-5 border-t border-border text-center text-sm text-muted">
          No account?{' '}
          <Link href="/signup" className="text-gold hover:text-gold2 font-semibold transition-colors font-cinzel">
